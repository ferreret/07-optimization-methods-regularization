...
for epoch in np.arange(0, args["epochs"]):
    ...
    # matrix 'W', then passs this value through our sigmoid activation function
    ...
    # our (1) features and (2) error of the sigmoid derivative of our predictions
    d = error * sigmoid_deriv(preds)
    gradient = np.dot(trainX.T, d)

    # in the update stage, all we need to do is "nudge" the weight matrix in the
    # negative direction of the gradient (hence the term "gradient descent" by taking a small step
